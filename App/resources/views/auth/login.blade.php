    ...
    <div class="flex-fill d-flex flex-column justify-content-center py-4">
        <div class="container-tight py-6">
            ...
            <div class="text-center text-muted mt">
                {{ __("Not an user?") }}
                <br />
                <a href="{{ url('company/login') }}" tabindex="-1">{{ __('Login as company') }}</a>
            </div>
            <div class="text-center text-muted mt">
                {{ __("Don't have an account yet?") }}
                <br />
                <a href="{{ url('register') }}" tabindex="-1">{{ __('Register as user') }}</a>
                <br />
                <a href="{{ url('company/register') }}" tabindex="-1">{{ __('Register as company') }}</a>
            </div>
        </div>
    </div>
@endsection
